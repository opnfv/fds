...
Scenario: apex-os-nosdn-fdio-ha

"apex-os-nosdn-ha" is a scenario developed as part of the FastDataStacks
OPNFV project. The main components of the "apex-os-nosdn-fdio-ha" scenario
are:
...
A deployment of the "apex-os-nosdn-fdio-ha" scenario consists of 4 or more
servers:
...
The apex-os-nosdn-fdio-ha scenario combines components from two key open
...
To enable the "apex-os-nosdn-fdio-ha" scenario check the appropriate settings
